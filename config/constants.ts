...
export const AIRTABLE_CONFIG = {
  ...
  TABLES: {
    ...
    PLANNED_TRANSACTIONS: process.env.EXPO_PUBLIC_AIRTABLE_PLANNED_TRANSACTIONS_TABLE || 'goals',
    ACCOUNTS: process.env.EXPO_PUBLIC_AIRTABLE_ACCOUNTS_TABLE || 'accounts',
  },
